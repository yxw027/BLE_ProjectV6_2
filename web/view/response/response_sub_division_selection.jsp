<%-- 
    Document   : response_sub_division_selection
    Created on : Jun 15, 2020, 7:12:13 PM
    Author     : prachi
--%>
    ...
    <c:choose>        
        ...
        <table cellspacing="0" border="0" id="table0"  align="center" width="50%">
            ...
            <tr style="font-size:larger ;font-weight: 700;" align="center">
                <td>
                    "${parameter_name}" Response Sub Division Selection Values Details
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <form name="form1" id ="form1" action="ResponseSubDivisionSelectionController" method="post" >
                        <table id="dataTable" style="border-collapse: collapse;" border="1" width="100%" align="center">
                                ...
                                <c:forEach var="list" items="${requestScope['subDivisionSelectionListById']}" varStatus="loopCounter">
                                    <tr>
                                        <td><input type="text" name="s_no${loopCounter.count}" id="s_no${loopCounter.count}" size="5" value="${loopCounter.count}" readonly>
                                            <input type="hidden" name="sub_division_selection_id${loopCounter.count}" maxlength="8" size="8" id="response_sub_division_selection_id${loopCounter.count}" value="${list.response_sub_division_selection_id}"></td>
                            ...
                            <input  type="hidden" name="response_sub_byte_division_id" value="${response_sub_byte_division_id}">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function autocompleteMethod(id, count) {
                debugger;
                if (id === "parameter") {
                    $("#parameter" + count).autocomplete("FixedResponseValueController", {
                        extraParams: {
                            action1: function () {
                                return "getParameter";
                            }
