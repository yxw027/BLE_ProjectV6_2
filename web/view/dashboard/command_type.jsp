    ...
    <body onload="zoom();" style="background-color: rgb(56, 165, 238, 0.5);">
        ...
        <div id="page-inner" style="background-color: rgb(56, 165, 238, 0.02);">
            ...
            <div class="row" style="margin-top: 10px;margin-left: 10%;margin-right: 10%;font-size:14px" id="table_for_module_type">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Command Type Table</div>
                                    ...
                                    <tbody>
                                        <c:forEach var="model" items="${requestScope['list2']}"
                                            ...
                                            <tr
                                                ...
                                                <td id="${loopCounter.count }2">${model.command_type}</td>
                                                <td id="${loopCounter.count }3">${model.short_hand}</td>
                                                <td id="${loopCounter.count }4">${model.active}</td>                                                                                               
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
            ...
            <div class="row" style="margin-top: 10px;margin-left: 10%;margin-right: 10%;font-size:14px ;padding:0px 15px 0px 15px" id="">
                <form method="post" action="CommandTypeController" name="form1" style="background-color: white;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5" style="margin-top:35px">                            
                            <input type="text" disabled name="command_type" id="command_type" class="form-control m-input" placeholder="Enter Command Type" required>
                        </div>                        
                    </div>

                    <div class="row">
                        <div class="col-lg-5 col_label">
                            <label class="required" style="font-size:20px;">Short Hand:</label>
                        </div>
                        <div class="col-lg-5">                            
                            <input type="text" disabled name="short_hand" id="short_hand" class="form-control m-input" placeholder="Enter Short Hand" required>
                        </div>                        
                    </div>
