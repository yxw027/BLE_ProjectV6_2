    ...
    <body onload="zoom();" style="background-color: rgb(56, 165, 238, 0.5);">
        ...
        <div id="page-inner" style="background-color: rgb(56, 165, 238, 0.02);">
            ...
            <div class="row" style="margin-top: 10px;margin-left: 10%;margin-right: 10%;font-size:14px" id="table_for_module_type">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Manufacturer Table</div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover"
                                       id="dataTables_Manufacturer" style="margin-bottom: 5px;">
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
                                    ...
                                    <tbody>
                                        <c:forEach var="model" items="${requestScope['list2']}"
                                            ...
                                            <tr
                                                onclick="fillColumn('${model.manufacturer_id}','${loopCounter.count }');">
                                                <td>${loopCounter.count }</td>
                                                <td id="${loopCounter.count }2">${model.manufacturer_name}</td>
                                                <td id="${loopCounter.count }3">${model.remark}</td>
                                                <td id="${loopCounter.count }4">${model.is_active}</td>
                                                <td id="${loopCounter.count }5">${model.created_at}</td>                                                
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
            ...
            <div class="row" style="margin-top: 10px;margin-left: 10%;margin-right: 10%;font-size:14px ;padding:0px 15px 0px 15px" id="">
                <form method="post" action="ManufacturerController" name="form1" style="background-color: white;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5" style="margin-top:35px">                            
                            <input type="text" disabled name="manufacturer_name" id="manufacturer_name" class="form-control m-input" placeholder="Enter Manufacturer Name" required>
                        </div>                        
                    </div>
        ...
        <script>
                            $(document).ready(function () {
                                /* $('#dataTables-example').dataTable();
                                 "pageLength": 25 */
                                $('#dataTables_Manufacturer').dataTable({
                                    //"autoWidth": false,
                                    //"lengthChange": false,
                                    "pageLength": 5,
