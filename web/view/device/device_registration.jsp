...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        ...
        $("#searchManufactureName").autocomplete("DeviceRegistrationCont.do", {
            extraParams: {
                action1: function() { return "getSearchManufactureName"}
            }
        });
        $("#searchDeviceType").autocomplete("DeviceRegistrationCont.do", {
            extraParams: {
    ...
    function makeEditable(id) {
        ...
        document.getElementById("manufacturer_name").disabled = false;
         ...
         document.getElementById("manufacture_date").disabled = false;
         document.getElementById("sale_date").disabled = false;
...
//        document.getElementById("revise").disabled =false;
    ...
    function fillColumns(id) {
        ...
        document.getElementById("device_registration_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        ...
        document.getElementById("registration_no").value = document.getElementById(t1id +(lowerLimit+6)).innerHTML;
        document.getElementById("manufacture_date").value = document.getElementById(t1id +(lowerLimit+7)).innerHTML;
        document.getElementById("sale_date").value = document.getElementById(t1id +(lowerLimit+8)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Device Registration</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="DeviceRegistrationCont.do">
                                    ...
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                ...
                                                <th class="heading">Registration No.</th>
                                                <th class="heading">Manufacture Date</th>
                                                <th class="heading">Sale Date</th>
                                            ...
                                            <c:forEach var="divisionTypeBean" items="${requestScope['divisionTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${divisionTypeBean.device_registration_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.registration_no}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.manufacture_date}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.sale_date}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="DeviceRegistrationCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <input class="input" type="hidden" id="device_registration_id" name="device_registration_id" value="" ></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th class="heading1">Registration No.</th>
                                                <td><input class="input" type="text" id="registration_no" name="registration_no" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Manufacture Date</th>
                                                <td><input class="input" type="text" id="manufacture_date" name="manufacture_date" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Sale Date</th>
                                                <td><input class="input" type="text" id="sale_date" name="sale_date" value="" size="40" disabled></td>
                                            </tr>
