<%-- 
    Document   : ntripbase
    Created on : Mar 14, 2020, 11:35:05 AM
...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchbaseName").autocomplete("NtripBaseCont.do", {
            extraParams: {
                action1: function() { return "getBaseName"}
            }
        });
    ...
    function makeEditable(id) {
        ...
        document.getElementById("base_name").disabled = false;
         document.getElementById("base_password").disabled = false;
...
//        document.getElementById("revise").disabled =false;
        ...
        //    document.getElementById("created_date").disabled = true;
           // document.getElementById("active").value ='';
            ...
            document.getElementById("base_name").focus();
            $("#message").html("");
    ...
    function fillColumns(id) {
        ...
        document.getElementById("ntrip_base_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("base_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        document.getElementById("base_password").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="NtripBaseCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <td>Base Name<input class="input" type="text" id="searchbaseName" name="searchbaseName" value="${searchbaseName}" size="20" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="NtripBaseCont.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                <th class="heading">S.No.</th>
                                                <th class="heading">Base Name</th>
                                                <th class="heading">Base Password</th>

                                                <th class="heading">Remark</th>
                                            </tr>
                                            <!---below is the code to show all values on jsp page fetched from trafficTypeList of TrafficController     --->
                                            <c:forEach var="ntripbaseBean" items="${requestScope['baseTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${ntripbaseBean.ntrip_base_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${ntripbaseBean.base_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${ntripbaseBean.base_password}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${ntripbaseBean.remark}</td>
