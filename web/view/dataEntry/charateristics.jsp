<%-- 
    ...
    Created on : Apr 17, 2019, 5:25:24 PM
    Author     : Shobha
--%>
...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#service_name").autocomplete("CharachtristicsCont.do", {
            extraParams: {
                action1: function() { return "getServiceName"}
            }
        });
        
        $("#service_uuid").autocomplete("CharachtristicsCont.do", {
            extraParams: {
                action1: function() { return "getServiceUuid"},
                action2: function() { return  $("#service_name").val();}
            }
        });
//        $("#model").autocomplete("CharachtristicsCont.do", {
//            extraParams: {
...
//        });
        ...
        $("#searchCharachtersticName").autocomplete("CharachtristicsCont.do", {
            extraParams: {
                action1: function() { return "getSearchCharachtersticName"}
    ...
    function makeEditable(id) {
        ...
        document.getElementById("service_uuid").disabled = false;
        document.getElementById("charachtristics_name").disabled = false;
...
//        document.getElementById("revise").disabled =false;
        ...
        //    document.getElementById("created_date").disabled = true;
           // document.getElementById("active").value ='';
            ...
            document.getElementById("charachtristics_name").focus();
            $("#message").html("");
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Revise'||document.getElementById("clickedButton").value == 'Delete') {
            ...
            var service_uuid = document.getElementById("service_uuid").value;
            var charachtristics_name = document.getElementById("charachtristics_name").value;
            var uuid = document.getElementById("uuid").value;
            
            var a=document.getElementById("active").value;
            //    alert(a);
            if(myLeftTrim(charachtristics_name).length == 0) {
                

                // document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Charachterstic Name is required...</b></td>");
                document.getElementById("charachtristics_name").focus();
                return false; // code to stop from submitting the form2.
            }
            if(myLeftTrim(service_name).length == 0) {

                // document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Service Name is required...</b></td>");
                document.getElementById("service_name").focus();
                return false; // code to stop from submitting the form2.
            }
            
            if(myLeftTrim(service_uuid).length == 0) {

                // document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Service UUID is required...</b></td>");
                document.getElementById("service_uuid").focus();
                return false; // code to stop from submitting the form2.
            }
            
            if(myLeftTrim(uuid).length == 0) {

                // document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>UUID is required...</b></td>");
...
//alert("2");
        ...
        document.getElementById("charachtristics_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("charachtristics_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        //alert("3");
        document.getElementById("service_name").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
        document.getElementById("service_uuid").value = document.getElementById(t1id +(lowerLimit+4)).innerHTML;
        document.getElementById("uuid").value = document.getElementById(t1id +(lowerLimit+5)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Charachteristics</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="CharachtristicsCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <td>Charachteristic Name<input class="input" type="text" id="searchCharachtersticName" name="searchCharachtersticName" value="${searchDeviceType}" size="20" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="CharachtristicsCont.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                <th class="heading">S.No.</th>
                                                <th class="heading">Characteristic Name</th>
                                                <th class="heading">Service Name</th>
                                                <th class="heading">Service Uuid</th>
                                                <th class="heading">Characteristic Uuid</th>
                                            ...
                                            <c:forEach var="divisionTypeBean" items="${requestScope['divisionTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${divisionTypeBean.charachtristics_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.charachtristics_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.service_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.service_uuid}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.uuid}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="CharachtristicsCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Charachtristics Name </th>

                                                <td><input class="input" type="text" id="charachtristics_name" name="charachtristics_name" value="" size="40" disabled>
                                                <input class="input" type="hidden" id="charachtristics_id" name="charachtristics_id" value="" ></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Service Name</th>
                                                <td><input class="input" type="text" id="service_name" name="service_name" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Service Uuid</th>
                                                <td><input class="input" type="text" id="service_uuid" name="service_uuid" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">UUID</th>
                                                <td><input class="input" type="text" id="uuid" name="uuid" value="" size="40" disabled></td>
                                            </tr>
