<%-- 
    Document   : parameter
    Created on : 9 Sep, 2019, 2:06:38 PM
    Author     : apogee
--%>
...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchParameterName").autocomplete("ParameterCont.do", {
            extraParams: {
                action1: function() { return "getParameterName"}
            }
        });
...
//        document.getElementById("revise").disabled =false;
    ...
    function fillColumns(id) {
        ...
        document.getElementById("parameter_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("parameter_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        document.getElementById("parameter_type").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
                    ...
                    <nav>
                        ...
                        <a href="CommandTypeCont.do">Command Type</a> 
                           <a href="CommandCont.do">Command</a> 
                             <a href="device_operation_commandController">DeviceOperationCommandMap</a>
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Parameter</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="ParameterCont.do">
...
<!--                                                <td>Rule<input class="input" type="text" id="searchRule" name="searchRule" value="${searchRule}" size="20" ></td>-->
                                                <td>Parameter Name<input class="input" type="text" id="searchParameterName" name="searchParameterName" value="${searchParameterName}" size="20" ></td>
...
<!--                                                <td><input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList()"></td>-->
                                ...
                                <form name="form1" method="POST" action="ParameterCont.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="parameter" items="${requestScope['parameterList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${parameter.parameter_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${parameter.parameter_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${parameter.parameter_type}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${parameter.remark}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="ParameterCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Parameter Name </th>
                                                <td><input class="input" type="text" id="parameter_name" name="parameter_name" value="" size="40" disabled>
                                                <input class="input" type="hidden" id="parameter_id" name="parameter_id" value="" ></td>
                                            </tr>
                                            <tr>
