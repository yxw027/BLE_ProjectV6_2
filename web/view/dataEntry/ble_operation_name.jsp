<%-- 
    Document   : ble_operation_name
    Created on : Jan 9, 2019, 4:03:36 PM
    Author     : jpss
--%>
...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchCommandName").autocomplete("BleOperationNameCont.do", {
            extraParams: {
...
//        document.getElementById("revise").disabled =false;
        ...
        //    document.getElementById("created_date").disabled = true;
           // document.getElementById("active").value ='';
            ...
            document.getElementById("ble_operation_name").focus();
            $("#message").html("");
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Revise'||document.getElementById("clickedButton").value == 'Delete') {
            var division_name_m = document.getElementById("ble_operation_name").value;
            ...
            if(myLeftTrim(division_name_m).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>ble_operation_name is required...</b></td>");
                document.getElementById("ble_operation_name").focus();
    ...
    function fillColumns(id) {
        ...
        document.getElementById("ble_operation_name_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("ble_operation_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">BLE Operation Name</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="BleOperationNameCont.do">
...
<!--                                                <td>Rule<input class="input" type="text" id="searchRule" name="searchRule" value="${searchRule}" size="20" ></td>-->
                                                <td>Ble Operation Name<input class="input" type="text" id="searchCommandName" name="searchCommandName" value="${searchCommandName}" size="20" ></td>
...
<!--                                                <td><input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList()"></td>-->
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="BleOperationNameCont.do">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="divisionTypeBean" items="${requestScope['divisionTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${divisionTypeBean.ble_operation_name_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="BleOperationNameCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input" type="text" id="ble_operation_name" name="ble_operation_name" value="" size="100" disabled></td>
                                                <td><input class="input" type="hidden" id="ble_operation_name_id" name="ble_operation_name_id" value="" ></td>
                                            </tr>                                          
                                            <tr>
