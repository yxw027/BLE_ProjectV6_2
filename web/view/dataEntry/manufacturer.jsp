...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchManufacturerName").autocomplete("ManufacturerCont.do", {
            extraParams: {
...
//        document.getElementById("revise").disabled =false;
    ...
    function fillColumns(id) {
        ...
        document.getElementById("manufacturer_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Manufacturer DETAIL</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="ManufacturerCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="ManufacturerCont.do">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="divisionTypeBean" items="${requestScope['divisionTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${divisionTypeBean.manufacturer_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="ManufacturerCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input" type="text" id="manufacturer" name="manufacturer" value="${manufacturer}" size="40" disabled>
                                                <input class="input" type="hidden" id="manufacturer_id" name="manufacturer_id" value="" ></td>
                                            </tr>  
                                            <tr>
