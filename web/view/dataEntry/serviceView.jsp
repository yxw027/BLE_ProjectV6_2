<%-- 
    ...
    Created on : Apr 16, 2019, 1:20:00 PM
    Author     : Shobha
--%>
...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        ...
        $("#searchServiceName").autocomplete("ServiceCont.do", {
            extraParams: {
                action1: function() { return "getSearchServiceName"}
...
//        document.getElementById("revise").disabled =false;
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Revise'||document.getElementById("clickedButton").value == 'Delete') {
            ...
            if(myLeftTrim(manufacturer).length == 0) {
            ...
            if(myLeftTrim(device_type).length == 0) {

                // document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Device Type is required...</b></td>");
...
//alert("2");
        ...
        document.getElementById("service_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("service_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        //alert("3");
        document.getElementById("service_uuid").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
        document.getElementById("manufacturer").value = document.getElementById(t1id +(lowerLimit+4)).innerHTML;
        document.getElementById("device_type").value = document.getElementById(t1id +(lowerLimit+5)).innerHTML;
        document.getElementById("model").value = document.getElementById(t1id +(lowerLimit+6)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Services</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="ServiceCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <td>Service Name<input class="input" type="text" id="searchServiceName" name="searchServiceName" value="${searchDeviceType}" size="20" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="ServiceCont.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                ...
                                                <th class="heading">Model Device Name</th>
                                            ...
                                            <c:forEach var="divisionTypeBean" items="${requestScope['divisionTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${divisionTypeBean.service_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${divisionTypeBean.model}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="ServiceCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input" type="text" id="service_name" name="service_name" value="" size="40" disabled>
                                                <input class="input" type="hidden" id="service_id" name="service_id" value="" ></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input" type="text" id="device_type" name="device_type" value="" size="40" disabled></td>
                                            </tr>
