...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchDeviceType").autocomplete("DeviceTypeCont.do", {
            extraParams: {
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Device Type</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="DeviceTypeCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="DeviceTypeCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="DeviceTypeCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input" type="text" id="device_type" name="device_type" value="${manufacturer}" size="40" disabled>
                                                <input class="input" type="hidden" id="device_type_id" name="device_type_id" value="" ></td>
                                            </tr>
                                            <tr>
