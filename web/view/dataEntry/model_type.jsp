...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#searchModelType").autocomplete("ModelTypeCont.do", {
            extraParams: {
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Model Type</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="ModelTypeCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="POST" action="ModelTypeCont.do" onsubmit="return verify()">
