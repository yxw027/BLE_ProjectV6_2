                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%">Operation Name</td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="OperationNameCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="OperationNameCont.do">
