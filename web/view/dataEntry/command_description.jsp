...
<script type="text/javascript" language="javascript">
  ...
  jQuery(function(){
        $("#searchCommandName").autocomplete("CommandDescriptionCont.do", {
            extraParams: {
 ...
 jQuery(function(){
        $("#command").autocomplete("CommandDescriptionCont.do", {
            extraParams: {
                action1: function() { return "getSearchCommandName"}
            }
        });
...
//    }
    ...
    <%-- for e.g. suppose id is t1c3 we want characters after t1c i.e beginIndex = 3. --%>
        ...
        debugger;
        document.getElementById("command_description_id").value = document.getElementById(t1id + (lowerLimit + 0)).innerHTML;

        document.getElementById("command").value = document.getElementById(t1id + (lowerLimit + 2)).innerHTML;

        document.getElementById("position").value = document.getElementById(t1id + (lowerLimit + 3)).innerHTML;

        document.getElementById("length").value = document.getElementById(t1id + (lowerLimit + 4)).innerHTML;
        debugger;
        ...
        <DIV id="body" class="maindiv" align="center" >
            <table width="100%" align="center">
                <tr><td>
                        <table align="center">
                            <tr>
                                <td align="center" class="header_table" width="100%">Command Description</td>
                        ...
                        <tr>
                            ...
                            <form name="form0" method="POST" action="CommandDescriptionCont.do">
                                <table align="center" class="heading1" width="600">
                                    <tr>
                                        <td>Command Name</td><td><input class="input" type="text" id="searchCommandName" name="searchCommandName" value="${searchCommandName}" size="20" ></td>
...
<!--                                        <td><input type="button" class="button" id="viewPdf" name="viewPdf" value="Pdf" onclick="displayMapList()"></td>-->
                        ...
                        <tr>
                            <td align="center">
                        <form name="form1" method="POST" action="CommandDescriptionCont.do">
                            <DIV class="content_div">
                                <table id="table1" width="600"  border="1"  align="center" class="content">
                                    ...
                                    <c:forEach var="commandDescriptionBean" items="${requestScope['commandDescriptionList']}"  varStatus="loopCounter">
                                        <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                            ...
                                            <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${commandDescriptionBean.command_description_id}</td>
                                            <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>

                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${commandDescriptionBean.command}</td>


                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${commandDescriptionBean.position}</td>
                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${commandDescriptionBean.length}</td>
                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${commandDescriptionBean.description}</td>
                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${commandDescriptionBean.remark}</td>
                ...
                <tr>
                    <td align="center">
                        <div>
                            <form name="form2" method="POST" action="CommandDescriptionCont.do" >
                                <table id="table2"  class="content" border="0"  align="center" width="600">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="input" type="text" id="command" name="command" value="${command}" size="40" disabled>
                                            <input class="input" type="hidden" id="command_description_id" name="command_description_id" value="" ></td>
                                    </tr>

                                    <tr>
                                        <th class="heading1">Position</th>
                                        <td><input class="input" type="text" id="position" name="position" value="" size="40" disabled>
                                        </td>
                                    </tr>
                                    <tr>
