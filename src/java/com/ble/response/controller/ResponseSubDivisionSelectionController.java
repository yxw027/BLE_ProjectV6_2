 ...
 * @author user
 */
public class ResponseSubDivisionSelectionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResponseSubDivisionSelectionModel subDivisionSelectionModel = new ResponseSubDivisionSelectionModel();
        ...
        int response_sub_byte_division_id = Integer.parseInt(request.getParameter("response_sub_byte_division_id"));
        ...
        if (task.equals("Save")) {
            ...
            if (sub_division_no != null) {
                ...
                for (int i = 1; i <= selection; i++) {
                    ...
                    subDivisionSelectionBean.setResponse_sub_byte_division_id(response_sub_byte_division_id);
...
//        noOfRowsTraversed = selectionList.size();
        ...
        List<ResponseDivisionSelectionBean> subDivisionSelectionListById = subDivisionSelectionModel.showData(lowerLimit, noOfRowsToDisplay, searchSelectionName, parameter, response_sub_byte_division_id);
...
//        request.setAttribute("selectionList", selectionList);
        ...
        request.setAttribute("response_sub_byte_division_id", response_sub_byte_division_id);
        ...
        request.getRequestDispatcher("/response_sub_division_selection").forward(request, response);
