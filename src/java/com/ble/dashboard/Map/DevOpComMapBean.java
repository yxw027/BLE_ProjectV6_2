...
public class DevOpComMapBean {
    ...
    private List<DevOpComMapBean> device;
    private String name;
    int input_no, selection_no;

    public List<DevOpComMapBean> getDevice() {
        return device;
    }

    public void setDevice(List<DevOpComMapBean> device) {
        this.device = device;
    }
    ...
    public int getDevice_command_id() {
        return device_command_id;
    }

    public void setDevice_command_id(int device_command_id) {
        this.device_command_id = device_command_id;
    }
