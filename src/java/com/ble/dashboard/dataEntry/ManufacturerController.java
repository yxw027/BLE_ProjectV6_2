...
public class ManufacturerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(task.equals("Save")){
            ...
            bean.setManufacturer_name(request.getParameter("manufacturer_name"));            
        ...
        List<ManufacturerBean> list2 = model.showData();
        ...
        request.getRequestDispatcher("/manufacturer_detail").forward(request, response);
