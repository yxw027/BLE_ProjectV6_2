 ...
 * @author saini
 */
public class ResponseParameterModel {
    ...
    public List<ResponseParameterBean> showData() {
        List<ResponseParameterBean> list = new ArrayList<ResponseParameterBean>();
        ...
        try {
            ...
            while (rst.next()) {
                ResponseParameterBean bean = new ResponseParameterBean();
    ...
    public int insertRecordForOther(ResponseParameterBean bean) throws SQLException {
        String query = "";
    ...
    public int insertRecord(ResponseParameterBean bean, int selection_val, List<String> displayVal, List<String> byteVal) throws SQLException {
...
//            }
    ...
    public int insertRecordInBitWise(ResponseParameterBean bean, int bitiwse_no, List<String> subByteDiv, List<String> subDivSelNo, List<String> startPos, List<String> noOfBit, List<String> bitDispVal, List<String> bitByteVal) throws SQLException {
                ...
                for (int i=0;i<bitiwse_no;i++ ) {
                    ...
                    if(count>0){                        
                        for(int k=0;k<Integer.parseInt(subByteDiv.get(i));k++){
                            ...
                            psmt=null;
                            rst=null;
                            query4=" insert into sub_byte_division(byte_id,start_pos,no_of_bit,sub_division_no) "
                                    + " values(?,?,?,?) ";
                            ...
                            if(count>0){
                                ...
                                for(int j=0;j<Integer.parseInt(subDivSelNo.get(i));j++){
                                    psmt=null;
                                    rst=null;
