 ...
 * @author saini
 */
public class ResponseParameterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResponseParameterModel model = new ResponseParameterModel();
        ...
        if (task.equals("Save")) {
            ...
            try {
                ...
                if (request.getParameter("parameter_type").equals("Bitwise")) {
                    model.insertRecordInBitWise(bean,bitiwse_no,subByteDiv,subDivSelNo,startPos,noOfBit,bitDispVal,bitByteVal);
                }
                if (request.getParameter("parameter_type").equals("Input")) {
                    model.insertRecordForOther(bean);
                }
            } catch (SQLException ex) {
                Logger.getLogger(ResponseParameterController.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        List<ResponseParameterBean> list2 = model.showData();
        ...
        request.getRequestDispatcher("/response_parameter").forward(request, response);
