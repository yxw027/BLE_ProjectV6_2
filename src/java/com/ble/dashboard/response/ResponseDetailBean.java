...
public class ResponseDetailBean {
    ...
    private String fixed_response;
    private String variable_response;
    private String bitwise_response;
    ...
    /**
     * @return the fixed_response
     */
    public String getFixed_response() {
        return fixed_response;
    }

    /**
     * @param fixed_response the fixed_response to set
     */
    public void setFixed_response(String fixed_response) {
        this.fixed_response = fixed_response;
    }

    /**
     * @return the variable_response
     */
    public String getVariable_response() {
        return variable_response;
    }

    /**
     * @param variable_response the variable_response to set
     */
    public void setVariable_response(String variable_response) {
        this.variable_response = variable_response;
    }

    /**
     * @return the bitwise_response
     */
    public String getBitwise_response() {
        return bitwise_response;
    }

    /**
     * @param bitwise_response the bitwise_response to set
     */
    public void setBitwise_response(String bitwise_response) {
        this.bitwise_response = bitwise_response;
    }

    /**
     * @return the data_extract_type
     */
    ...
    /**
     * @param data_extract_type the data_extract_type to set
     */
